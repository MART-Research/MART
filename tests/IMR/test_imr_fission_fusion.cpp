...
int main(int argc, char* argv[]) {
    ...
    std::cout << "\nRunning IMR (Fission + Fusion) with " << numNodes << " nodes...\n";
    IMR imr(flowNetwork, flows, numNodes, 1); // 1 is the concentration factor
    imr.run_imr_fission_fusion();
...
#include <algorithm>
#include <cmath>
#include "../oct_v2/headers/routers/IMR.h"
