...
int main()
{
    ...
    ifstream ifs("config_xor");
    if (!ifs)
    {
        cerr << "ERROR: cannot open config_xor\n";
        return 1;
    }
    string line;
    ...
    for (int i = 0; i < num_tests; ++i)
    {
        ...
        vector<int> path = Xor.route(src, dst, hopcount, vcs, flow);
