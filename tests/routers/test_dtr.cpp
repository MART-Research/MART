...
int main()
{
    ...
    ifstream ifs("config_dtr");
    if (!ifs)
    {
        cerr << "ERROR: cannot open config_dtr\n";
        return 1;
    }
    string line;
    ...
    for (int i = 0; i < num_tests; ++i)
    {
        ...
        vector<int> path = dtr.route(src, dst, hopcount, vcs, flow);
    ...
    cout << "All DestinationTag tests passed!\n";
    return 0;
}
